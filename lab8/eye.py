...
lib.SERVOGet.argtypes = [ctypes.c_int]
lib.SERVOGet.restype = ctypes.c_int
lib.SERVODone.argtypes = [ctypes.c_int]
lib.SERVODone.restype = ctypes.c_int
lib.SERVOWait.argtypes = [ctypes.c_int]
lib.SERVOWait.restype = ctypes.c_int
lib.SERVOStalled.argtypes = [ctypes.c_int]
lib.SERVOStalled.restype = ctypes.c_int
lib.SERVOSetExtension.argtypes = [ctypes.c_int, ctypes.c_int]
lib.SERVOSetExtension.restype = ctypes.c_int
lib.SERVOSetAngle.argtypes = [ctypes.c_int, ctypes.c_int]
lib.SERVOSetAngle.restype = ctypes.c_int
...
def SERVOGet(servo):
	return lib.SERVOGet(ctypes.c_int(servo))

def SERVODone(servo):
	return lib.SERVODone(ctypes.c_int(servo))

def SERVOWait(servo):
	return lib.SERVOWait(ctypes.c_int(servo))

def SERVOStalled(servo):
	return lib.SERVOStalled(ctypes.c_int(servo))

def SERVOSetExtension(servo, dist):
	return lib.SERVOSetExtension(ctypes.c_int(servo), ctypes.c_int(dist))

def SERVOSetAngle(servo, angle):
	return lib.SERVOSetAngle(ctypes.c_int(servo), ctypes.c_int(angle))
